...
import {
  Search, ShoppingBag, ArrowRight, Zap, Shield, Headphones,
  Award, Star, TrendingUp, Sparkles, ChevronLeft, ChevronRight,
  Plus, Layers, Clock, Flame, User2
} from 'lucide-react'
    ...
    <div className="home-page">
      ...
      <section className="about-section" id="about">
        <div className="section-header-centered">
          ...
          <h2>Chào mừng đến với <span className="gradient-text">ESale</span></h2>
          <p>Hệ thống bán hàng trực tuyến hàng đầu chuyên cung cấp các sản phẩm điện tử chính hãng</p>
        </div>
        <div className="about-grid">
          <div className="about-card glass-card">
            ...
            <p>Hàng trăm sản phẩm điện tử từ các thương hiệu uy tín trong và ngoài nước, đáp ứng mọi nhu cầu của bạn.</p>
          </div>
          <div className="about-card glass-card">
            ...
            <p>Hệ thống vận chuyển nhanh chóng, giao hàng trong vòng 24h cho khu vực nội thành.</p>
          </div>
          <div className="about-card glass-card">
            ...
            <p>Tất cả sản phẩm đều được bảo hành chính hãng, đổi trả trong 30 ngày nếu có lỗi từ nhà sản xuất.</p>
          </div>
        </div>
      </section>
      ...
      <section className="why-us-section">
        <div className="section-header-centered">
          ...
          <h2>Vì sao chọn <span className="gradient-text">chúng tôi</span>?</h2>
        ...
        <div className="why-us-grid">
          <div className="why-card">
            ...
            <div className="why-content">
              <h4><Award size={20} /> Chất lượng hàng đầu</h4>
              <p>Chỉ phân phối sản phẩm chính hãng 100%, nguồn gốc rõ ràng từ các nhà cung cấp uy tín.</p>
            </div>
          </div>
          <div className="why-card">
            <div className="why-number">02</div>
            <div className="why-content">
              <h4><Star size={20} /> Giá cả cạnh tranh</h4>
              <p>Cam kết giá tốt nhất thị trường. Hoàn tiền chênh lệch nếu bạn tìm thấy giá rẻ hơn.</p>
            </div>
          </div>
          <div className="why-card">
            <div className="why-number">03</div>
            <div className="why-content">
              <h4><Headphones size={20} /> Hỗ trợ 24/7</h4>
              <p>Đội ngũ tư vấn viên luôn sẵn sàng hỗ trợ bạn mọi lúc, mọi nơi qua đa kênh liên lạc.</p>
            </div>
          </div>
          <div className="why-card">
            <div className="why-number">04</div>
            <div className="why-content">
              <h4><Shield size={20} /> Thanh toán an toàn</h4>
              <p>Hệ thống thanh toán được mã hóa SSL, đảm bảo an toàn tuyệt đối cho mọi giao dịch.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="owner-card glass-card">
          ...
          <div className="owner-info">
            ...
            <div className="owner-quote">
              <em>"Sự hài lòng của khách hàng là thước đo thành công của chúng tôi."</em>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="products-section" id="products">
        <div className="section-header-centered">
          ...
          <h2>Khám phá <span className="gradient-text">sản phẩm</span> của chúng tôi</h2>
        ...
        {search && (
          <div className="search-filter-info">
            ...
            <button onClick={() => { setSearch(''); setSearchParams({}) }} className="clear-filter">✕ Xóa</button>
          ...
          {loading ? (
            ...
            <div className="product-grid">
              {paginatedProducts.map((product) => (
                <ProductCard key={product.ID_sanpham || product.id} product={product} onDelete={refreshProducts} />
              ))}
            </div>
          )}
        </div>
